package com.sashkolearn.mainagent.infrastructure.redis;
...
public class RedisService {
    ...
    public boolean setIfAbsent(String key, long updateIdTtlSeconds) {
        Boolean isNew = redisTemplate.opsForValue().setIfAbsent(
                key,
                "1",
                Duration.ofSeconds(updateIdTtlSeconds)
        );
