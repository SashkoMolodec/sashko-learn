...
public class QuizFlowService {
     ...
     */
    public void storeQuizQuestions(UUID quizId, List<GetQuizResultDto.QuestionDto> questions) {
     ...
     */
    public List<GetQuizResultDto.QuestionDto> getQuizQuestions(UUID quizId) {
        String key = QUIZ_QUESTIONS_PREFIX + quizId;
     ...
     */
    public void startQuiz(Long chatId, UUID quizId, String topic, List<GetQuizResultDto.QuestionDto> questions) {
        // Shuffle questions for variety on each attempt
        List<GetQuizResultDto.QuestionDto> shuffled = new ArrayList<>(questions);
    ...
    public void handlePollAnswer(Long userId, String pollId, List<Integer> selectedOptions) {
        ...
        if (questionNumber >= session.totalQuestions()) {
            ...
            List<GetQuizResultDto.QuestionDto> questions = getQuizQuestions(quizId);
            if (questions != null) {
                GetQuizResultDto.QuestionDto nextQuestion = nextQuestionNumber <= questions.size()
     ...
     */
    private void sendQuestionPoll(Long chatId, UUID quizId, GetQuizResultDto.QuestionDto question, int currentNum, int totalNum) {
