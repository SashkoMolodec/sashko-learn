...
public class PdfProcessingService {
    ...
    public List<ChapterInfo> extractChapterTitles(String pdfPath) throws IOException {
       ...
       /* try (PDDocument document = PDDocument.load(new File(pdfPath))) {
            ...
            return List.of(new ChapterInfo(
                1,
                "Complete Book",
                1,
   ...
   /* private List<ChapterInfo> extractFromBookmarks(PDDocument document) {
        List<ChapterInfo> chapters = new ArrayList<>();
    ...
    private List<ChapterInfo> findChaptersInText(String text, int pageNumber) {
        List<ChapterInfo> chapters = new ArrayList<>();
